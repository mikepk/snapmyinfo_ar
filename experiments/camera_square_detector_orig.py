...
def find_contours( img, storage ):
    ...
    # count, square = cvFindContours(template_img,storage,sizeof_CvContour, CV_RETR_LIST, CV_CHAIN_APPROX_SIMPLE, cvPoint(0,0) )
        
    for image in test_images:
        # original:
        # count, contours = cvFindContours( gray, storage, sizeof_CvContour,
        #     CV_RETR_LIST, CV_CHAIN_APPROX_SIMPLE, cvPoint(0,0) );
        count, contours = cvFindContours( image, storage, sizeof_CvContour,
            CV_RETR_LIST, CV_CHAIN_APPROX_SIMPLE, cvPoint(0,0) );
...
if __name__ == "__main__":
    ...
    while 1:
        ...
        # img0 = cvGetSubRect( img, cvRect(272,192,107,107))
        ...
        # for x in range(1):
        #     if rect:
        #        img0 = cvGetSubRect( img, rect ) 
        # working_img = down_sample(img0,1)
